!(function () {
  ...
  function r(t, e, o) {
    ...
    e = n(t, "link", { rel: "stylesheet", href: e, media: "all" });
    var s = !1,
      r = !0,
      f = null,
      c = o || null;
    M
      ? ((e.onload = function () {
        ...
        (e.onerror = function () {
          (s = !0), (f = Error("Stylesheet failed to load")), a();
        }))
      : setTimeout(function () {
          (s = !0), a();
        }, 0),
  ...
  function y(t) {
    if (t.g) {
      var n = a(t.f, t.a.c("wf", "active")),
        i = [],
        e = [t.a.c("wf", "loading")];
      n || i.push(t.a.c("wf", "inactive")), o(t.f, i, e);
    }
    b(t, "inactive");
  }
  function b(t, n, i) {
    t.j && t.h[n] && (i ? t.h[n](i.c, v(i)) : t.h[n]());
  }
  function j(t, i) {
    (this.c = t),
      (this.f = i),
      (this.a = n(this.c, "span", { "aria-hidden": "true" }, this.f));
  }
  function x(t) {
    i(t.c, "body", t.a);
  }
  ...
  function T(t, n, i, e, o, a, s) {
    (this.v = t),
      ...
      (this.o = new j(this.c, this.s)),
      (t = _((t = new d(this.a.c + ",serif", v(this.a))))),
      (this.g.a.style.cssText = t),
      (t = _((t = new d(this.a.c + ",sans-serif", v(this.a))))),
      (this.h.a.style.cssText = t),
      (t = _((t = new d("serif", v(this.a))))),
      (this.j.a.style.cssText = t),
      (t = _((t = new d("sans-serif", v(this.a))))),
  ...
  function C(t, n, i) {
    for (var e in z)
      if (z.hasOwnProperty(e) && n === t.f[z[e]] && i === t.f[z[e]]) return !0;
    return !1;
  }
  function N(n) {
    var i,
      e = n.g.a.offsetWidth,
      o = n.h.a.offsetWidth;
    (i = e === n.f.serif && o === n.f["sans-serif"]) || (i = S() && C(n, e, o)),
      i
        ? H() - n.A >= n.w
          ? S() && C(n, e, o) && (null === n.u || n.u.hasOwnProperty(n.a.c))
            ? A(n, n.v)
            : A(n, n.B)
          : (function (n) {
              setTimeout(
  ...
  function A(n, i) {
    setTimeout(
      t(function () {
        e(this.g.a), e(this.h.a), e(this.j.a), e(this.o.a), i(this.a);
      }, n),
      0
    );
  }
  ...
  function I(n, i, e, a, s) {
    var r = 0 == --n.h;
    (n.f || n.g) &&
      setTimeout(function () {
        var n = s || null,
          f = a || null || {};
        if (0 === e.length && r) y(i.a);
        else {
          (i.f += e.length), r && (i.j = r);
          var c,
            h = [];
          for (c = 0; c < e.length; c++) {
            var l = e[c],
              ...
              p = i.a,
              d = l;
            p.g && o(p.f, [p.a.c("wf", d.c, v(d).toString(), "loading")]),
              b(p, "fontloading", d),
              (p = null),
              null === K &&
                (K =
                  ...
                  (!(d = /Gecko.*Firefox\/(\d+)/.exec(
                    ...
                    42 < parseInt(d[1], 10))),
              (p = K
                ? new k(t(i.g, i), t(i.h, i), i.c, l, i.s, u)
                : new T(t(i.g, i), t(i.h, i), i.c, l, i.s, n, u)),
              h.push(p);
          }
  ...
  function P(t, n, i) {
    var e = [],
      a = i.timeout;
    !(function (t) {
      t.g && o(t.f, [t.a.c("wf", "loading")]), b(t, "loading");
    })(n);
      ...
      if (2 <= e.length) {
        ...
        0 < s.length && (a = s),
          3 == e.length &&
            ((e = e[2]),
            (s = []),
            0 < (e = e ? e.split(",") : s).length &&
              (e = U[e[0]]) &&
              (t.c[o] = e));
      }
      for (t.c[o] || ((e = U[o]) && (t.c[o] = e)), e = 0; e < a.length; e += 1)
        t.a.push(new d(o, a[e]));
    }
  }
  function D(t, n) {
    (this.c = t), (this.a = n);
  ...
  (E.prototype.g = function (t) {
    ...
    n.g &&
      o(
        n.f,
        [n.a.c("wf", t.c, v(t).toString(), "active")],
        [
          n.a.c("wf", t.c, v(t).toString(), "loading"),
          n.a.c("wf", t.c, v(t).toString(), "inactive"),
        ]
      ),
      b(n, "fontactive", t),
      (this.o = !0),
    ...
    (E.prototype.h = function (t) {
      var n = this.a;
      if (n.g) {
        var i = a(n.f, n.a.c("wf", t.c, v(t).toString(), "active")),
          e = [],
          s = [n.a.c("wf", t.c, v(t).toString(), "loading")];
        i || e.push(n.a.c("wf", t.c, v(t).toString(), "inactive")),
          o(n.f, e, s);
      }
      b(n, "fontinactive", t), W(this);
    }),
          ...
          if (o)
            for (var r = 0; r < o.length; r++) {
              ...
              void 0 != o[r].fontStyle && void 0 != o[r].fontWeight
                ? ((i = o[r].fontStyle + o[r].fontWeight), s.push(new d(f, i)))
                : s.push(new d(f));
            }
          t(s);
        } else
    ...
    (O.prototype.load = function (t) {
      var n,
        ...
        s = new c();
      for (n = 0, i = e.length; n < i; n++) r(this.c, e[n], h(s));
      var f = [];
      for (n = 0, i = o.length; n < i; n++)
        if ((e = o[n].split(":"))[1])
          for (var u = e[1].split(","), p = 0; p < u.length; p += 1)
            f.push(new d(e[0], u[p]));
        else f.push(new d(e[0]));
      l(s, function () {
        t(f, a);
      });
    });
          ...
          (i.__webfontfontdeckmodule__[n] = function (n, i) {
            for (var o = 0, a = i.fonts.length; o < a; ++o) {
              ...
              e.a.push(
                new d(
                  s.name,
                  w("font-weight:" + s.weight + ";font-style:" + s.style)
                )
              );
            }
            t(e.a);
  ...
  var Y = new F(window);
  (Y.a.c.custom = function (t, n) {
    return new O(n, t);
  }),
    (Y.a.c.fontdeck = function (t, n) {
      return new q(n, t);
    }),
    (Y.a.c.monotype = function (t, n) {
      return new B(n, t);
    }),
    (Y.a.c.typekit = function (t, n) {
      return new $(n, t);
    }),
    (Y.a.c.google = function (t, n) {
      return new D(n, t);
    });
  var Z = { load: t(Y.load, Y) };
